...
#            num_node_attributes = self.num_node_attributes + 47 # BZR 6
#            num_node_attributes = self.num_node_attributes + 3 # COX2 6
#            num_node_attributes = self.num_node_attributes +12 # PTC_MR 6
#            num_node_attributes = self.num_node_attributes +1 # MUTAG 6
#            num_node_attributes = self.num_node_attributes +14 # PTC_MM 6
            num_node_attributes = self.num_node_attributes
#            num_node_attributes = self.num_node_attributes + 46
